...
- **Get started**: [Quick Start Guide](getting-started.md) — write your first MC script in 10 minutes
- **How it works**: [Architecture](architecture.md) — Rhino engine, scope isolation, build pipeline
- **API reference**: [API by Task](../api/README.md) — find APIs by "I want to..."
